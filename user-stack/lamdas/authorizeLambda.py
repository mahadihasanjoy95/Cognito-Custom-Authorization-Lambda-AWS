...
#     return generatePolicy("user|a1b2c3d4", 'Allow', event['methodArn'])
#
#
...
userpool_id = CognitoUserPool
app_client_id = CongnitoPoolClientId
print("USER POOL CLIENT ID::::::::::::: ", CongnitoPoolClientId)
